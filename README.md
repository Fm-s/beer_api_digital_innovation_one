<h1>Branch do Projeto Principal</h1>
<h3>Alterações</h3>
<ul>
<li>Acrescentado campo de estoque mínimo a entidade Beer</li>
<li>Implementado metodo de decremento ao BeerService</li>
<li>Implementado nova exceção para estoque minimo</li>
</ul>
